...
str(trainData)
```
Let's remove unnecessary variables.  Variables that have a lot of NA should be removed.  Which variables have lot of NAs?
...
rbind(prediction_rf_validation,
      prediction_xgboost_validation,
      prediction_tree_validation)
